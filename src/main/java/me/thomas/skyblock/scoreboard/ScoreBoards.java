package me.thomas.skyblock.scoreboard;
...
public class ScoreBoards {
    ...
    public static void setScoreboard(Player player) {
        ...
        season.setSuffix(ChatColor.WHITE + "1th");
        ...
        objective.getScore(ChatColor.YELLOW + "www.spigotmc.org").setScore(0);
